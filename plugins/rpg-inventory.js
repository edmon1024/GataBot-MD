...
┃ ${rpgg.emoticon('money')} *AstroCoins: » ${money}*
...
_2.Top AstroCoins_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}*
...
*│ ⛏️🐱 Minar AstroCoins » ${new Date - user.lastcoins < 600000 ? '❌' : '✅'}*
