...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE ASTROBOT 🌟`}
...
const smsLista7 = () => { return `🚀 INSTALAR ASTROBOT 🚀`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 𝗦𝘂𝗽er AstroBot - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar AstroBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar AstroBot en Grupos`}
...
const smsContacto4 = () => { return 'Contacto Oficial de AstroBot 🐈'}
