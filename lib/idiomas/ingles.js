...
const smsLista1 = () => { return `🌟 ASTROBOT INFORMATION 🌟`}
...
const smsLista7 = () => { return `🚀 INSTALL ASTROBOT 🚀`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 Super AstroBot - WhatsApp '}
...
const eAstroCoins = () => { return '🐱 AstroCoins' }
const eAstroTickers = () => { return '🎫 Astro Tickers' } 
...
const smsModP2 = () => { return `Enable function so everyone can use AstroBot`}
const smsModAd1 = () => { return `🛂 ADMIN MODE`}
const smsModAd2 = () => { return `Only Admins will be able to use AstroBot in Groups`}
...
const smsJBInfo2 = () => { return `💖 *The function is stable.`}
...
const smsContacto4 = () => { return 'AstroBot Official Contact 🚀'}
